...
if LOTAYA_NODE_VERSION=21.0.0 LOTAYA_CERT_DIR="${TMP}/missing" bash "${REPO}/deploy/check-deploy-prerequisites.sh" >/dev/null 2>&1; then echo "unsupported Node.js was accepted" >&2;exit 1;fi
