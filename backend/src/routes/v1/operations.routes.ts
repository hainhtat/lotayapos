...
operationsRouter.post("/parcels/returns/preview", requireAuth, requireRoles("SUPERADMIN", "OPERATIONS_MANAGER", "DISPATCHER", "FINANCE", "AUDITOR"), returnHandoverValidation, validation, asyncHandler(previewReturnHandover));
operationsRouter.post("/parcels/returns/pdf", requireAuth, requireRoles("SUPERADMIN", "OPERATIONS_MANAGER", "DISPATCHER", "FINANCE", "AUDITOR"), returnHandoverValidation, validation, asyncHandler(downloadReturnHandover));
operationsRouter.post("/parcels/paid-to-os/preview", requireAuth, requireRoles("SUPERADMIN", "OPERATIONS_MANAGER", "DISPATCHER", "FINANCE", "AUDITOR"), paidToOsHandoverValidation, validation, asyncHandler(previewPaidToOsHandover));
operationsRouter.post("/parcels/paid-to-os/pdf", requireAuth, requireRoles("SUPERADMIN", "OPERATIONS_MANAGER", "DISPATCHER", "FINANCE", "AUDITOR"), paidToOsHandoverValidation, validation, asyncHandler(downloadPaidToOsHandover));
