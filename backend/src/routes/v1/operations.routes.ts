...
operationsRouter.post("/parcels/os-handover/pdf", requireAuth, requireRoles("SUPERADMIN", "OPERATIONS_MANAGER", "DISPATCHER", "FINANCE", "AUDITOR"), combinedOsHandoverValidation, validation, asyncHandler(downloadCombinedOsHandover));
