CREATE TABLE "OsBatchObligation" (
  ...
  "hubId" TEXT NOT NULL,
  "originalCod" INTEGER NOT NULL,
  "migrated" BOOLEAN NOT NULL DEFAULT true,
  "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "OsBatchObligation_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "Batch" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
SELECT 'migrated-' || b."id", b."id", b."shopId", b."hubId", COALESCE(SUM(p."codAmount"), 0), true
...
CREATE TABLE "OsAccountPayment" (
  ...
  "businessDate" DATETIME NOT NULL, "note" TEXT NOT NULL, "reference" TEXT,
  "status" TEXT NOT NULL DEFAULT 'POSTED', "idempotencyKey" TEXT NOT NULL,
  "postedBy" TEXT NOT NULL, "voidedAt" DATETIME, "voidedBy" TEXT, "voidReason" TEXT,
  "replacesId" TEXT, "replacedById" TEXT, "journalEntryId" TEXT NOT NULL,
  "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "OsAccountPayment_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "OnlineShop" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "OsPaymentWallet" (
  "id" TEXT NOT NULL PRIMARY KEY, "paymentId" TEXT NOT NULL, "wallet" TEXT NOT NULL, "amount" INTEGER NOT NULL,
  CONSTRAINT "OsPaymentWallet_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "OsAccountPayment" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
CREATE UNIQUE INDEX "OsPaymentWallet_paymentId_wallet_key" ON "OsPaymentWallet"("paymentId", "wallet");

CREATE TABLE "OsPaymentAllocation" (
  "id" TEXT NOT NULL PRIMARY KEY, "paymentId" TEXT NOT NULL, "batchId" TEXT NOT NULL, "amount" INTEGER NOT NULL,
  CONSTRAINT "OsPaymentAllocation_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "OsAccountPayment" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "OsPaymentAllocation_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "Batch" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "OsReturnCredit" (
  "id" TEXT NOT NULL PRIMARY KEY, "parcelId" TEXT NOT NULL, "batchId" TEXT NOT NULL,
  "shopId" TEXT NOT NULL, "hubId" TEXT NOT NULL, "amount" INTEGER NOT NULL,
  "businessDate" DATETIME NOT NULL, "status" TEXT NOT NULL DEFAULT 'POSTED',
  "idempotencyKey" TEXT NOT NULL, "postedBy" TEXT NOT NULL, "journalEntryId" TEXT,
  "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
);
