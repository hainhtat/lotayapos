...
CREATE TABLE "OsAdvanceCreditAllocation" (
  ...
  CONSTRAINT "OsAdvanceCreditAllocation_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "Batch"("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "OsAdvanceCreditAllocation_creditId_fkey" FOREIGN KEY ("creditId") REFERENCES "OsReturnCredit"("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
